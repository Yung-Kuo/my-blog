...
<template>
  <div
    class="group fixed right-6 top-6 z-30 flex h-12 w-12 cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-neutral-500 text-3xl transition-all dark:bg-neutral-800"
